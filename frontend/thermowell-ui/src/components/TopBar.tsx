      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative" ref={profileRef}>
          <div 
            ...
            className="flex items-center gap-2 cursor-pointer hover:bg-gray-50 rounded-lg px-2 py-1 transition-colors duration-200"
          >
            <div className="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center text-white font-bold">
              {userName ? userName.charAt(0) : 'U'}
            </div>
            <span className="text-gray-700 text-sm font-medium hidden md:block">{userName || 'User'}</span>
            <svg 
